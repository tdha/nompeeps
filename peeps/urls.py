...
urlpatterns = [
    ...
    path('peeps/<int:peeps_id>/add_group/<int:group_id>', views.add_group, name='add_group'),
    path('peeps/<int:peeps_id>/remove_group/<int:group_id>', views.remove_group, name='remove_group'),
